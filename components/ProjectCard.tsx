      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <div className="flex items-center justify-between pt-4" style={{ borderTop: '1px solid rgba(200,134,10,0.12)' }}>
          ...
          <div className="flex items-center gap-2">
            {project.demoUrl && (
              <a href={project.demoUrl} target="_blank" rel="noopener noreferrer" className="text-[#6a5a3a] transition-colors hover:text-[#f0a500]" aria-label="Live demo">
            ...
            {project.githubUrl && (
              <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="text-[#6a5a3a] transition-colors hover:text-[#f0a500]" aria-label="Repository">
