...
function slugifyHeading(value: { children?: Array<{ _type: string; text?: string }> }): string {
...
export const portableTextComponents: PortableTextComponents = {
  block: {
    h1: ({ children, value }) => (
      <h1
        ...
        className="text-body mt-12 mb-6 scroll-mt-20 text-4xl leading-tight font-extrabold md:text-5xl"
      >
        {children}
      </h1>
    ),
    h2: ({ children, value }) => (
      <h2
        id={slugifyHeading(value)}
        className="text-body mt-10 mb-4 scroll-mt-20 text-3xl leading-snug font-bold md:text-4xl"
      >
        {children}
      </h2>
    ),
    h3: ({ children, value }) => (
      <h3
        id={slugifyHeading(value)}
        className="text-body mt-8 mb-3 scroll-mt-20 text-2xl leading-snug font-bold md:text-3xl"
      >
        {children}
      </h3>
    ),
    h4: ({ children, value }) => (
      <h4
        id={slugifyHeading(value)}
        className="text-body mt-6 mb-3 scroll-mt-20 text-xl leading-snug font-bold md:text-2xl"
      >
        {children}
      </h4>
    ),
  ...
  types: {
    ...
    // CodeBlock already renders its own copy button in the header bar
