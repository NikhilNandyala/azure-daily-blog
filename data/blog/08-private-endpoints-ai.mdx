---
title: 'Fixing Private Endpoint Issues with Azure OpenAI: DNS, NSG, and SDK'
date: '2026-04-02'
summary: 'If your Azure OpenAI calls fail after adding a private endpoint — with timeouts, 401s, or connections that bypass the endpoint entirely — the cause is almost always in one of four places: DNS resolution, App Service VNet routing, NSG subnet policies, or SDK endpoint configuration. Here is how to diagnose and fix each one.'
