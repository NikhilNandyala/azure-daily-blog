...
<img src="/images/projects/enterprise-portal-architecture.svg" alt="Enterprise Customer Portal full architecture: Front Door → App Gateway WAF → VNet (App Service + .NET API + Azure SQL private endpoint) + shared services + Azure DevOps CI/CD pipeline" />
