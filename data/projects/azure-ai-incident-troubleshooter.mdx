...
date: '2026-07-02'
description: 'A full-stack AI-powered incident management system that uses Azure OpenAI, Cosmos DB (11 containers, referenced entity model), and Azure AI Search to automatically analyse infrastructure incidents, surface root causes, and recommend remediation actions — built as an end-to-end instructional guide.'
techStack: ['Python', 'FastAPI', 'Next.js', 'Azure OpenAI', 'Azure AI Search', 'Cosmos DB', 'AKS', 'Helm', 'Key Vault', 'Workload Identity', 'GitHub Actions', 'Bicep']
category: ai
