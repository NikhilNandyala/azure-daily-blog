  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0B1220] px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
          ...
          {providers &&
            Object.values(providers).map((provider) => (
              <button
                ...
                className="group text-body relative flex w-full justify-center rounded-md border border-white/6 bg-[#1F2937] px-4 py-3 text-sm font-medium shadow-sm hover:bg-[#374151] focus:ring-2 focus:ring-[#38BDF8] focus:outline-none"
              >
        ...
        <div className="text-center">
          <Link href="/" className="text-accent hover:text-primary-300 text-sm">
            ← Back to home
          </Link>
        </div>
      </div>
